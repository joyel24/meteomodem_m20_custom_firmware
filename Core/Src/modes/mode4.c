...
void mode4(){
	...
	*/
	...
	while (activeMode == 4 ){
		...
		//char bits[] = "";

		uint16_t len = strlen(bits);

		while (bitNumber < len){
			uint32_t i = 0;
			//while ( ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) ) < bitNumber*(8000000/(1200)) ){
				if (bits[bitNumber] == '1'){
					//TIM21_value = ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) );
					while ( ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) ) < bitNumber*(8000000/(1200)) ){
						//HAL_TIM_P
						TIM21_value = ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) );
						//i=0;
						while ( ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) ) < (TIM21_value+i*(8000000/(2*1200))) /*(TIM21_value + (8000000/(2*1200)) )*/ ){}
					...
					while ( ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) ) < bitNumber*(8000000/(1200)) ){
						TIM21_value = ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) );
						while ( ( (TIM21_increment * 65535) + __HAL_TIM_GET_COUNTER(&htim21) ) <  (TIM21_value+i*(8000000/(2*2200))) /*(TIM21_value + (8000000/(2*2200)) )*/ ){}
							HAL_GPIO_TogglePin(ADF7012_TxDATA_GPIO_Port, ADF7012_TxDATA_Pin);
							HAL_GPIO_TogglePin(LED_GPIO_Port, LED_Pin);
							i++;
					}
